...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><a href="index.html">IPDS</a></h1>
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#"><span>Prakom</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            ...
                            <li><a href="/userkamusprakom">Kamus</a></li>
    ...
    <section id="hero" class="d-flex align-items-center">
        ...
        <div class="container d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
            <h1>Dapatkan Informasi</h1>
            <h2>Memperoleh informasi tugas dan wewenang Prakom & Statistisi</h2>
