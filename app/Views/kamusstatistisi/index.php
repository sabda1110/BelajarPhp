                    ...
                    <?php foreach ($kamus as $row) : ?>
                        <tr>
                            ...
                            <td class="" style="text-align: center;">
                                ...
                                <a href="/kamusstatistisi/hapus/<?= $row['kode_kegiatan'] ?>" id="btn-hapus" class="btn btn-sm btn-danger" data-id=""> <i class="fa fa-trash"></i> </a>
                                <button type="button" data-toggle="modal" data-target="#modalEdit" class="btn btn-sm btn-warning" id="btn-edit" data-kode_kegiatan="<?= $row['kode_kegiatan'] ?>" data-kegiatan="<?= $row['kegiatan'] ?>" data-desc_kegiatan="<?= $row['desc_kegiatan'] ?>" data-satuan_hasil="<?= $row['satuan_hasil'] ?>" data-angka_kredit="<?= $row['angka_kredit'] ?>" data-pelaksana="<?= $row['pelaksana'] ?>" data-bukti_fisik="<?= $row['bukti_fisik'] ?>" data-contoh="<?= $row['contoh'] ?>" data-kode_jabatan="<?= $row['kode_jabatan'] ?>"> <i class="fa fa-edit"></i></button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="kamusstatistisi/tambahkamus" method="post">
...
<div class="modal fade" id="modalEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="kamusstatistisi/edit" method="post">

                    <input type="hidden" name="kode_kegiatan" id="kode_kegiatan" class="form-control" placeholder="Masukan Kode Kegiatan">
